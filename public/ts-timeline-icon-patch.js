(() => {
  ...
  function storiesPrintCss() {
    return [
      ...
      '@media print{.daily-page,.style2-page{height:auto!important;min-height:0!important;overflow:visible!important}.daily-details,[data-day-things-flow="1"],.style2-details{display:grid!important;grid-template-columns:1fr 1fr!important;gap:8px 12px!important;align-items:start!important}}',
      '.style2-thing .thing-head,.style2-page .thing-head{grid-template-columns:32px minmax(0,1fr)!important;width:100%!important;min-width:0!important;padding-right:0!important}',
      '.style2-thing .thing-head h3,.style2-thing h3,.style2-page h3{max-width:100%!important;padding-right:0!important;overflow-wrap:break-word!important;word-break:normal!important;white-space:normal!important}',
      ...
      '[data-last-page-logo="1"]{display:flex!important;flex-direction:row;flex-wrap:nowrap;align-items:center;justify-content:center;gap:10px;text-align:center;width:100%;margin-top:10mm;padding:4mm 0 2mm;break-before:avoid;page-break-before:avoid;font-family:Georgia,serif;font-size:13px;font-weight:700;letter-spacing:.04em;color:#111827}',
      '[data-last-page-logo="1"] .ts-logo{display:inline-block!important;width:28px;height:28px;margin:0;object-fit:contain;flex:0 0 auto}',
      ...
      '[data-stories-two-col="1"] .story-card,[data-stories-packed="1"] .story-card,[data-story-card]{display:block!important;width:auto!important;max-width:100%!important;min-width:0!important;margin:0 0 8px!important;break-inside:auto;page-break-inside:auto;break-before:auto!important;break-after:auto!important}',
      'main.daily-details[data-day-things-flow="1"]{display:grid!important;grid-template-columns:1fr 1fr!important;gap:8px 12px!important;align-items:start!important}',
      'main.style2-details[data-day-things-flow="1"],[data-print-ready=style2] .style2-details{display:grid!important;grid-template-columns:1fr 1fr!important;gap:8px 12px!important;align-items:start!important;width:100%!important}',
      '[data-day-things-flow="1"] .daily-thing{width:auto!important;max-width:100%!important;min-width:0!important;padding-right:0!important;margin:0 0 8px!important}',
      '.style2-page{height:auto!important;min-height:0!important;overflow:visible!important;display:block!important;text-align:center!important;break-inside:auto!important;page-break-inside:auto!important}',
      '[data-style2-centered-day]{display:block!important;break-after:auto!important;page-break-after:auto!important}',
      '.style2-page .thing,.style2-thing,[data-print-ready=style2] .thing,[data-story-card],.story-card,[data-stories-packed="1"] .thing{break-before:auto!important;break-after:auto!important;page-break-before:auto!important;page-break-after:auto!important}',
      '.style2-details,[data-print-ready=style2] .style2-details{display:grid!important;grid-template-columns:1fr 1fr!important;gap:8px 12px!important;width:100%!important;text-align:left!important;align-items:start!important}',
      '.style2-details>.thing,.style2-details>.style2-thing{display:block!important;width:auto!important;max-width:100%!important;min-width:0!important}',
