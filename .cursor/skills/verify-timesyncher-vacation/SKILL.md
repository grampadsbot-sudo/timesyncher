...
- reviewer commands must run as GitHub Actions vacation-verify on the SHA; doctor binds job conclusion=success and artifact digest via the GitHub API, not yaml text or a committed receipt skip; Vercel deploy status is not that evidence
