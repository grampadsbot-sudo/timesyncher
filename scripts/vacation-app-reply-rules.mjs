...
function replyRulesSystem(rules, destination, upsell) {
  ...
  return [
    ...
    'Item34 ban: never say "splitting payments", "split payment", "split-payer", or "splitting payment". If one seat is already covered and another person has their own seat, say that. Do not frame seats as a payment split.',
    upsellLine,
