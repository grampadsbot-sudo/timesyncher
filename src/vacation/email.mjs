...
export function purchaseEmail({ contact, token, env = process.env }) {
  ...
  const textBody = [
    ...
    '',
    'Click the button below to get started on your unforgettable TimeSyncher Vacation!',
    '',
    `Start TimeSyncher Vacation: ${onboardingUrl}`,
    `Direct bot link: ${botUrl}`,
    '',
...
<html><body style="margin:0;background:#050505;color:#fffaf0;font-family:Arial,sans-serif">
  <div style="max-width:640px;margin:0 auto;padding:28px">
    ...
    <p>Hi ${name},</p>
    <p>Click the button below to get started on your unforgettable TimeSyncher Vacation!</p>
    ...
    <p>You can also open the bot directly with this tokenized link:</p>
