...
export function assertPatchedStyleTwo(source = '') {
  ...
  if (!js.includes('data-summary-continued="1"') || !js.includes('${wn}${sm}${js}${zl}${Qi}${lg}')) {
    throw new Error('Summary continued pages must exist with top-margin bar data-summary-continued.');
  }
  if (!js.includes('data-last-logo-page="1"') || !js.includes('justify-content:flex-end') || !js.includes('[data-day-map-page="1"]{break-before:page')) {
    throw new Error('Day maps must page-break alone; last-page logo must be a dedicated bottom-centered page.');
  }
