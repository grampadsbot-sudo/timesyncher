...
const BA_PATCH = '`<figure class="print-media-card" data-print-media="bound"><img src="${an(So(G.url||G.thumbnailUrl))}" alt="${an(Re)}" /><figcaption>${an(Re)}</figcaption></figure>`';
